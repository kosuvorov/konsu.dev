---
title: "The only iPhone teleprompter that floats over TikTok - and still hears you"
description: "Only two iOS teleprompters can float over other apps, and only one of them follows your voice. How picture-in-picture prompting works with TikTok, Instagram, and any camera app - tested live."
date: 2026-07-07
tldr: "Two iPhone teleprompters can float over other apps: Floating Notes (fixed-speed only, so one ad-lib and you've lost your place) and VoicePrompter, the only app that combines the floating window with real voice tracking. It works over TikTok, Instagram, Snapchat, and any camera app - I've run it live on TikTok. Disclosure: VoicePrompter is my app."
faq:
  - q: "Can you use a teleprompter while recording in the TikTok or Instagram app?"
    a: "Yes - a picture-in-picture teleprompter floats on top of TikTok or Instagram while their camera records you. The script never appears in the video because the phone records the camera, not the screen."
  - q: "Does a floating teleprompter show up in the video?"
    a: "No. Apps like TikTok, Instagram, and Snapchat record from the camera, so the floating window is visible only to you on the screen."
  - q: "Which teleprompter apps can float over other iPhone apps?"
    a: "As of mid-2026, two: Teleprompter: Floating Notes (fixed-speed scrolling only) and VoicePrompter (voice tracking plus sound and constant modes, with hands-free voice commands)."
  - q: "Does floating teleprompter work during TikTok Live?"
    a: "Yes - I've used VoicePrompter's floating window through entire TikTok Live sessions. Voice commands let you restart or jump around the script without touching the phone mid-stream."
---
...
The obvious fix would be a teleprompter that floats over other apps. What surprised me when I went through the whole App Store category: **almost nobody has built one.** Out of the ten most popular iOS teleprompters, exactly two can do it - and only one of them can hear you. Disclosure before we go further: that one is [VoicePrompter](https://voiceprompter.app/ios/), which I build. Judge the claim by the specifics below.
