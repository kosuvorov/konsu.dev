...
[**Try it →**](https://kosuvorov.github.io/linkedin-connections-graph/)
[Source on GitHub](https://github.com/kosuvorov/linkedin-connections-graph)
...
2. Open the [link above](https://kosuvorov.github.io/linkedin-connections-graph/), drop in the `Connections.csv`.
